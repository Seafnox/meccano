...
// metric_thread (diameter=4, pitch=0.5, length=8, thread_size=0.5, quality = 64);
...
// ----------------------------------------------------------------------------
function segments (diameter, quality) = min (128, max (ceil (diameter*quality), 25));
...
module metric_thread (diameter=8, pitch=1, length=1, internal=false, n_starts=1,
                      ...
                      angle=30, taper=0, leadin=0, leadfac=1.0, test=false, quality = 8)
{
   ...
   n_segments = segments (diameter, quality);
   ...
   difference () {
      union () {
         if (! groove) {
            if (! test) {
               metric_thread_turns (diameter, pitch, length, internal, n_starts, local_thread_size, groove, square, rectangle, angle, taper, quality);
            }
         }
...
module english_thread (diameter=0.25, threads_per_inch=20, length=1,
                      ...
                      leadfac=1.0, test=false, quality = 8)
{
   // Convert to mm.
...
module metric_thread_turn (diameter, pitch, internal, n_starts, thread_size,
                           groove, square, rectangle, angle, taper, z, quality)
{
   n_segments = segments (diameter, quality);
   ...
   for (i=[0 : n_segments-1]) {
      ...
      rotate ([0, 0, (i + 0.5)*360*fraction_circle + 90]) {
         translate ([0, 0, i*n_starts*pitch*fraction_circle]) {
            ...
            thread_polyhedron ((diameter - taper*(z + i*n_starts*pitch*fraction_circle))/2, pitch, internal, n_starts, thread_size, groove, square, rectangle, angle, quality);
         }
      }
   }
}
...
module thread_polyhedron (radius, pitch, internal, n_starts, thread_size,
                          groove, square, rectangle, angle, quality)
{
   n_segments = segments (radius*2, quality);
   fraction_circle = 1.0/n_segments;
